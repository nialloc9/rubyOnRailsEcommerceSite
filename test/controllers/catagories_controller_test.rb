...
class CatagoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catagory" do
    assert_difference('Catagory.count') do
      post catagories_url, params: { catagory: { description: @catagory.description, image_url: @catagory.image_url, name: @catagory.name } }
    end
  ...
  test "should update catagory" do
    patch catagory_url(@catagory), params: { catagory: { description: @catagory.description, image_url: @catagory.image_url, name: @catagory.name } }
